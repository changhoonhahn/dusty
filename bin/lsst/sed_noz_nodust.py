...
# get data 
maggies     = np.load('/scratch/gpfs/chhahn/dusty/nihao_lsst_maggies_nodust_noisy.npy')
sig_maggies = np.load('/scratch/gpfs/chhahn/dusty/nihao_lsst_sig_maggies_nodust.npy')
...
for iang in range(10): 
    ...
    fsamp = os.path.join(dat_dir, 'mcmc/pocomc.lsst.noz.nodust.%i.%i.samples.npy' % (igal, iang))
    fweig = os.path.join(dat_dir, 'mcmc/pocomc.lsst.noz.nodust.%i.%i.weights.npy' % (igal, iang))
    flogl = os.path.join(dat_dir, 'mcmc/pocomc.lsst.noz.nodust.%i.%i.logl.npy' % (igal, iang))
    flogp = os.path.join(dat_dir, 'mcmc/pocomc.lsst.noz.nodust.%i.%i.logp.npy' % (igal, iang))

...
# get data 
maggies     = np.load('/scratch/gpfs/chhahn/dusty/nihao_lsst.v3.z0p4.maggies.npy')
sig_maggies = np.load('/scratch/gpfs/chhahn/dusty/nihao_lsst.v3.z0p4.sig_maggies.npy')
...
for iang in range(10): 
    ...
    fsamp = os.path.join(dat_dir, 'mcmc/pocomc.lsst.z0p4.noz.%i.%i.samples.npy' % (igal, iang))
    fweig = os.path.join(dat_dir, 'mcmc/pocomc.lsst.z0p4.noz.%i.%i.weights.npy' % (igal, iang))
    flogl = os.path.join(dat_dir, 'mcmc/pocomc.lsst.z0p4.noz.%i.%i.logl.npy' % (igal, iang))
    flogp = os.path.join(dat_dir, 'mcmc/pocomc.lsst.z0p4.noz.%i.%i.logp.npy' % (igal, iang))
